...
# This script estimates pairwise inter-media influence using a fixed effects model using looser conceptualizations of topics (using 10, 6 months seasons)
...
res |> write_csv("auxiliary/inter-media-influence_10seasons.csv")
