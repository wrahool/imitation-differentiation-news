...
generate_latex_table2 <- function(modelsfilepath, tablename) {
  ...
  curr_model_file <- get(ls(pattern = "qap_asym_neg_"))
  
  model_list <- list(
    LL_baseline_All = curr_model_file$`LL baseline All A`,
    LL_baseline_Pol = curr_model_file$`LL baseline Political A`,
    LL_baseline_Ent = curr_model_file$`LL baseline Entertainment A`,
    RR_baseline_All = curr_model_file$`RR baseline All A`,
    RR_baseline_Pol = curr_model_file$`RR baseline Political A`,
    RR_baseline_Ent = curr_model_file$`RR baseline Entertainment A`
  )
...
generate_latex_table2("results/new_qap_neg_asymmetry_results-adfontes.RData", "tables/table2R-adfontes.tex")

generate_latex_table2("results/new_qap_neg_asymmetry_results-10seasons.RData", "tables/table2R-10seasons.tex")

generate_latex_table2("results/new_qap_neg_asymmetry_results-placebo.RData", "tables/table2R-placebo.tex")
