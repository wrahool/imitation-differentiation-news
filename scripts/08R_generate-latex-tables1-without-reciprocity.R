...
generate_latex_table1 <- function(modelsfilepath, tablename) {
  ...
  latex_code <- paste0(
    ...
    "& \\multicolumn{3}{c}{DV: $\\text{logit}(P(y_{ij} = 1))$} & \\multicolumn{3}{c}{DV: $\\text{logit}(P(y^\\prime_{ij} = 1))$} \\\\\n",
    "\\cmidrule{2-7}\n",
...
generate_latex_table1("results/new_qap_results-60seasons-B.RData", "tables/table1R-without-reciprocity.tex")
