...
# This script does a robustness test for Table 1 using adfontes ideology
...
qap_cor_models_adfontes <- list("All A" = m1_all,
                       "All B" = m2_all,
                       "Political A" =  m1_pol,
                       "Political B" = m2_pol,
...
lrqap_pos_models_adfontes <- list("All A" = logit_pos_allA,
...
lrqap_neg_models_adfontes <- list("All A" = logit_neg_allA,
...
save(qap_cor_models_adfontes,
     lrqap_pos_models_adfontes,
     lrqap_neg_models_adfontes,
     file = "results/new_qap_results-adfontes.RData")
