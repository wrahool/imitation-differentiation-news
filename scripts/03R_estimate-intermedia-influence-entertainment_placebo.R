...
# but only for entertainment topics, placebo with -1 lag
...
for(lag in -1:-1) {
  ...
  entertainment_topics <- read_csv("auxiliary/topic_entertainment_60.csv")
...
res |> write_csv("auxiliary/inter-media-influence-entertainment-lagminus1.csv")
