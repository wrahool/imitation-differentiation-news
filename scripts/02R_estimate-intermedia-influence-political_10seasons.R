...
# but only for political topics, 10 seasons
...
for(lag in 1:1) {
  ...
  politics_topics <- read_csv("auxiliary/topic_politicization_handcode_10.csv")
...
res |> write_csv("auxiliary/inter-media-influence-political_10seasons.csv")
