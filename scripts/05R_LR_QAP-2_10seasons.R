...
qap_asym_neg_10seasons <- list("LL baseline All A" = model_neg_asym1A,
                               ...
                               "LL baseline Political A" = model_neg_asym_pol1A,
                               "LL baseline Political B" = model_neg_asym_pol1B,
                               "RR baseline Political A" = model_neg_asym_pol2A,
                               "RR baseline Political B" = model_neg_asym_pol2B,
                               
                               "LL baseline Entertainment A" = model_neg_asym_ent1A,
                               "LL baseline Entertainment B" = model_neg_asym_ent1B,
