...
# This script tests the imitation-differentiation dynamics using LRQAP, placebo test, using intermedia influence scores with -1 lag
...
res <- read_csv("auxiliary/inter-media-influence-lagminus1.csv")
res_p <- read_csv("auxiliary/inter-media-influence-political-lagminus1.csv")
res_e <- read_csv("auxiliary/inter-media-influence-entertainment-lagminus1.csv")
...
qap_cor_models_placebo <- list("All A" = m1_all,
                                 "All B" = m2_all,
                                 "Political A" =  m1_pol,
                                 "Political B" = m2_pol,
...
lrqap_pos_models_placebo <- list("All A" = logit_pos_allA,
...
lrqap_neg_models_placebo <- list("All A" = logit_neg_allA,
...
save(qap_cor_models_placebo,
     lrqap_pos_models_placebo,
     lrqap_neg_models_placebo,
     file = "results/new_qap_results-placebo.RData")
